...
%changelog
* Tue Sep 18 2018 RDO <dev@lists.rdoproject.org> 1.0.3-1
- Update to 1.0.3

* Mon Apr 09 2018 RDO <dev@lists.rdoproject.org> 1.0.2-1
- Update to 1.0.2

* Wed Aug 30 2017 rdo-trunk <javier.pena@redhat.com> 1.0.1-1
- Update to 1.0.1

* Wed Aug 30 2017 rdo-trunk <javier.pena@redhat.com> 1.0.0-1
- Update to 1.0.0

* Tue Aug 22 2017 Alfredo Moralejo <amoralej@redhat.com> 1.0.0-0.1.0rc2
- Update to 1.0.0.0rc2


# REMOVEME: error caused by commit http://git.openstack.org/cgit/openstack/octavia/commit/?id=b3a25ee45ff780a0d5338f208def51f4a75c008c
