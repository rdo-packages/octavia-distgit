...
%changelog
* Tue Nov 16 2021 RDO <dev@lists.rdoproject.org> 6.2.2-1
- Update to 6.2.2

* Thu Jul 29 2021 RDO <dev@lists.rdoproject.org> 6.2.1-1
- Update to 6.2.1

* Mon Mar 15 2021 RDO <dev@lists.rdoproject.org> 6.2.0-1
- Update to 6.2.0

* Mon Oct 19 2020 RDO <dev@lists.rdoproject.org> 6.1.0-1
- Update to 6.1.0

* Wed May 13 2020 RDO <dev@lists.rdoproject.org> 6.0.0-1
- Update to 6.0.0

* Wed May 06 2020 RDO <dev@lists.rdoproject.org> 6.0.0-0.1.0rc1
- Update to 6.0.0.0rc1

# REMOVEME: error caused by commit https://opendev.org/openstack/octavia/commit/3d56e7ad20ec3bf3280ca10f7e3d3754ea197b71
