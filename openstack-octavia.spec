...
# BuildRequires for test subpackage
...
# Generate http binary from httpd.go
...
mv httpd %{buildroot}%{python2_sitelib}/octavia/tests/contrib/
...
sed -i "s#self._build_static_httpd()#'/usr/lib/python2.7/octavia/tests/contrib/httpd'#g" $PATH1
sed -i "s#self._build_static_httpd()#'/usr/lib/python2.7/octavia/tests/contrib/httpd'#g" $PATH2
...
%{python2_sitelib}/%{service}/tests/contrib/httpd
